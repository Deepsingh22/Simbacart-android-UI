import 'package:Simbacart/Library/carousel_pro/carousel_pro.dart';
import 'package:flutter/material.dart';
import 'package:Simbacart/ListItem/HomeGridItemRecomended.dart';
import 'package:Simbacart/UI/HomeUIComponent/AppbarGradient.dart';
import 'package:Simbacart/Library/countdown/countdown.dart';
import 'package:Simbacart/UI/HomeUIComponent/CategoryDetail.dart';
import 'package:Simbacart/UI/HomeUIComponent/DetailProduct.dart';
import 'package:Simbacart/UI/HomeUIComponent/FlashSale.dart';
import 'package:Simbacart/UI/HomeUIComponent/MenuDetail.dart';
import 'package:Simbacart/UI/HomeUIComponent/PromotionDetail.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          CategoryIconValue(
            ...
            icon2: "assets/icon/shoe1.png",
            title2: "Lofars",
            tap3: onClickMenuIcon,
            icon3: "assets/icon/shoe.png",
            title3: "slippers",
          ),
    ...
    var FlashSell = Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(colors: [
          Color(0xFF7F7FD5).withOpacity(0.6),
          Color(0xFF86A8E7),
          Color(0xFF91EAE4)
        ]),
      ),
...
class CategoryIconValue extends StatelessWidget {
  String icon1, icon2, icon3, title1, title2, title3;
  GestureTapCallback tap1, tap2, tap3;
