...
import 'package:Simbacart/UI/BottomNavigationBar.dart';
import 'package:Simbacart/UI/HomeUIComponent/Home.dart';
import 'package:Simbacart/UI/LoginOrSignup/Login.dart';
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                /// Animation text Simbacart accept from splashscreen layout (Click to open code)
                                child: Hero(
                                  tag: "Treva",
                                  child: Text(
                                    "Simbacart",
                              ...
                              /// Padding Text "Get best product in Simbacart" (Click to open code)
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 160.0,
                                      right: 160.0,
