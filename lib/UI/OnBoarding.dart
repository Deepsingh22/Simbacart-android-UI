...
import 'package:Simbacart/Library/intro_views_flutter-2.4.0/lib/intro_views_flutter.dart';
...
final pages = [
  new PageViewModel(
      ...
      title: Text(
        'Ethinic Footwear',style: _fontHeaderStyle,
      ),
      body: Container(
        height: 250.0,
        child: Text(
          'Choose from a wide range \nof loafer shoes from Simbacart.',textAlign: TextAlign.center,
  ...
  new PageViewModel(
      ...
      body: Container(
        height: 250.0,
        child: Text(
            'Play them up for an alluring look thatll have you feeling all comfy & stylish',textAlign: TextAlign.center,
            style: _fontDescriptionStyle
        ),
      ),
      mainImage: Image.asset(
  ...
  new PageViewModel(
      ...
      body: Container(
        height: 250.0,
        child: Text(
            'courtesy the flawless construction \n the loafers are known for.6 ',textAlign: TextAlign.center,
            style: _fontDescriptionStyle
        ),
      ),
      mainImage: Image.asset(
